...
function ActivityFeed() {
  ...
  if (!mounted || !isVisible || activities.length === 0) {
    return (
      <div className="rounded-xl bg-card p-8 text-center" style={{ boxShadow: '0 0 0 1px rgba(0,0,0,0.06), 0 1px 2px -1px rgba(0,0,0,0.06), 0 2px 4px rgba(0,0,0,0.04)' }}>
  ...
  return (
    <div
      ...
      style={{ boxShadow: '0 0 0 1px rgba(0,0,0,0.06), 0 1px 2px -1px rgba(0,0,0,0.06), 0 2px 4px rgba(0,0,0,0.04)' }}
    >
