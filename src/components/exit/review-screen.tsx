        ...
        <div className="flex flex-col gap-5">
            <Card>
                ...
                <div className="grid grid-cols-2 gap-5 sm:grid-cols-3">
                    ...
                    <Stat
                        label="You recover"
                        value={<MoneyDisplay sats={pkg.totals.recoveredSats} />}
                    />
                    <Stat
                        label="Network fees"
            ...
            {expired && (
                ...
                >
                    This package’s <span className="font-mono">validUntil</span> has elapsed. The
                    ...
                    <Card>
                        ...
                        <div className="mt-3 flex flex-col gap-2">
                            ...
                            <p className="text-[11px] text-muted-foreground">
                                ...
                                <span className="font-mono">{pkg.network}</span>. Override only if
                                you run your own — must be CORS-permissive and expose{" "}
