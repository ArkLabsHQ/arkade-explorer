...
export function Footer() {
  return (
    <footer className="border-t-2 border-arkade-purple bg-arkade-black py-4 mt-auto">
      <div className="container mx-auto px-4 flex flex-col items-center gap-2">
        <p className="text-arkade-gray text-xs">
          YOU CAN JUST DO THINGS &copy; | POWERED BY ARKADE
        </p>
